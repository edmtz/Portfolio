...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Salvador Eduardo
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">As a  <b>Software Engineer</b> and <b>Quality Assurance</b> with +2 years of hands-on experience, 
          I specialize in delivering high-quality software solutions through meticulous testing and agile development practices.</p>
